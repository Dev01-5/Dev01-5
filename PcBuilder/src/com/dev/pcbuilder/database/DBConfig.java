...
public class DBConfig {
	...
	private static final String ERROR_URL_EMPTY = "Dev Mode enabled. URL has to be set";
	 ...
	 * @return
	 */
	public static String getURL() throws NullPointerException{
		if (DBConfig.mode == Mode.LIVE)
			return LIVE_URL;
		else
		{
			if (DBConfig.url == "")
				throw new NullPointerException(ERROR_URL_EMPTY);
			else
				return DBConfig.url;
		}
	}
